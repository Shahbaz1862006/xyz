          ...
          <div className="space-y-8 font-poppins text-sm leading-relaxed" style={{ color: 'var(--on-surface-2)' }}>
            {[
              ...
              },
              {
                ...
                body: 'Coinductor connects to the TRON blockchain and third-party services. We are not responsible for delays, failures, or losses caused by those external systems.',
              },
              {
              ...
              },
              {
                ...
                body: 'Cryptocurrency involves significant risk, including the risk of total loss. Fees and network conditions may change at any time.',
              },
              {
