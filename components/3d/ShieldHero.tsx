  ...
  return (
    ...
    >
      <Canvas
        ...
        frameloop="always"
      >
        {/* Keep lighting local. Drei's preset environments fetch a remote HDR image,
            which can fail in the browser and leave this canvas blank. */}
        <ambientLight intensity={isDark ? 0.65 : 1.1} color={isDark ? '#9fbfff' : '#eaf3ff'} />
